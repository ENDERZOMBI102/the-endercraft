...
<EE3:calcinator>.addTooltip(format.green("Multiblock structure, place under a glass bell."));
<EE3:glassBell>.addTooltip(format.green("Multiblock structure, place on a calcinator."));
//cobble
